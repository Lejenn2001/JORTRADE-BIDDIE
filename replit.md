...
- **Pricing Tiers**: Signal Scout ($49, no Biddie AI), Active Trader ($89, 25 questions/day), Pro Trader ($129, 50 questions/day). Daily limits enforced via `useQuestionLimit` hook (localStorage-based, resets at midnight). Signal Scout sees locked chat panel with upgrade prompt.
