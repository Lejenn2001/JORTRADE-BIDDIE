          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/[0.08] bg-[hsl(232,30%,7%)]">
            <svg className="absolute inset-0 w-full h-full opacity-[0.35]" viewBox="0 0 800 200" preserveAspectRatio="none">
              {[40, 90, 140, 190, 240, 290, 340, 390, 440, 490, 540, 590, 640, 690, 740].map((x, i) => {
                ...
                return (
                  <g key={i}>
                    <line x1={x} y1={tops[i] - 15} x2={x} y2={tops[i] + heights[i] + 15} stroke={green ? "#f97316" : "#fb923c"} strokeWidth="1" />
                    <rect x={x - 8} y={tops[i]} width="16" height={heights[i]} fill={green ? "#f97316" : "#fb923c"} rx="1" />
                  </g>
                );
              })}
            </svg>
            <div className="absolute inset-0 bg-gradient-to-r from-orange-900/15 via-transparent to-orange-900/10" />
            ...
            <div className="relative px-6 py-7">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] uppercase tracking-[0.3em] text-orange-400/80 font-semibold mt-0.5">
