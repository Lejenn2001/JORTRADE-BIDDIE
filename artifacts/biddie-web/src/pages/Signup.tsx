...
const plans = [
  {
    ...
    badge: null,
    desc: "See what Wall Street sees. Real-time signals from algorithms and institutional flow — before the crowd catches on.",
    icon: Star,
    features: [
      "Live Algorithm & Whale signal alerts",
      "Spread & Butterfly play detection",
      "AI conviction scoring on every signal",
      "DAY TRADE / SWING TRADE classification",
      "ACT NOW urgency alerts",
      "Biddie AI assistant — 5 questions/day",
      "JORTRADE community access",
      "5-day free trial",
    ],
    notIncluded: [
      "Deep flow analysis",
  ...
  },
  {
    ...
    badge: "Most Popular",
    desc: "Ask Biddie to break down any ticker, flow, or setup. Get the \"why\" behind every signal — not just the \"what.\"",
    icon: Zap,
    features: [
      "Everything in Starter",
      "Biddie AI assistant — 25 questions/day",
      "AI-powered options flow breakdown",
      "\"What should I trade right now?\" mode",
      "Gamma zone & key level analysis",
      "Real-time institutional flow reading",
      "JORTRADE community access",
      "5-day free trial",
    ],
    notIncluded: [
  ...
  },
  {
    ...
    badge: "Full Access",
    desc: "The full arsenal. 100 daily AI questions, performance analytics, signal tracking — built for traders who don't leave edge on the table.",
    icon: Crown,
    features: [
      "Everything in Active",
      "Biddie AI assistant — 100 questions/day",
      "Performance analytics dashboard",
      "Signal hit rate & accuracy tracking",
          ...
          <div className="glass-panel rounded-2xl p-8 border-glow-blue">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <Button type="button" variant="outline" className="flex-1 rounded-lg border-border/50" onClick={async () => {
                  const { error } = await supabase.auth.signInWithOAuth({ provider: "apple", options: { redirectTo: window.location.origin + (import.meta.env.BASE_URL || '/') } });
                  if (error) toast.error(error.message);
                }}>
