...
const exampleSignals: MarketSignal[] = [
  ...
  },
  {
    ...
    tags: ["Call Flow", "Sweep", "Debit Spread", "⚡ HIGH CONVICTION"],
    strike: "$580/$600",
    expiry: "April 3, 2026",
    premium: "$400K net debit",
    putCall: "call",
    suggestedTrade: "Buy META $580/$600 Call Debit Spread expiring April 3",
    entryTrigger: "Hold above $575 support with momentum",
    invalidation: "$570.00",
    keyLevel: "$578.00",
  ...
  },
  {
    ...
    tags: ["Call Flow", "Butterfly", "⚡ HIGH CONVICTION"],
    strike: "$200/$210/$220",
    expiry: "April 10, 2026",
    premium: "$180K net debit",
    putCall: "call",
    suggestedTrade: "Buy AMZN $200/$210/$220 Call Butterfly expiring April 10",
    entryTrigger: "AMZN trading between $205 – $215",
    invalidation: "$195.00",
    keyLevel: "$210.00",
  ...
  },
  {
    ...
    tags: ["Put Flow", "Call Flow", "Iron Condor", "⚡ HIGH CONVICTION"],
    strike: "$155/$160/$175/$180",
    expiry: "April 3, 2026",
    premium: "$320K credit",
    putCall: "put",
    suggestedTrade: "Sell GOOGL $155/$160/$175/$180 Iron Condor expiring April 3",
    entryTrigger: "GOOGL trading in $162 – $173 range",
