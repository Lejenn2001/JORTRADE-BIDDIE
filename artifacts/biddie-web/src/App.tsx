...
import DashboardPaperTrades from "./pages/DashboardPaperTrades.tsx";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/dashboard/paper-trades" element={<ProtectedRoute><DashboardPaperTrades /></ProtectedRoute>} />
