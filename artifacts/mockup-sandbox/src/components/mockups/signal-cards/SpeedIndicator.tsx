...
const CARDS: CardData[] = [
  {
    ...
    levels: [
      { label: "Area of Interest", value: "Holding above VWAP at $142.50 — confirmed" },
      { label: "Range", value: "$145 – $150", tone: "flow" },
      { label: "Key Level", value: "VWAP at $142.50" },
      { label: "Support", value: "Below Pivot at $138.00", tone: "bad" },
    ],
  ...
  },
  {
    ...
    levels: [
      { label: "Area of Interest", value: "Needs to reclaim VWAP at $176.00" },
      { label: "Range", value: "$182 – $188", tone: "flow" },
      { label: "Key Level", value: "VWAP at $176.00" },
      { label: "Support", value: "Below S1 at $168.00", tone: "bad" },
    ],
  ...
  },
  {
    ...
    levels: [
      { label: "Area of Interest", value: "Trading below VWAP at $584.00 — confirmed" },
      { label: "Range", value: "$575 – $568", tone: "flow" },
      { label: "Key Level", value: "VWAP at $584.00" },
      { label: "Resistance", value: "Above Pivot at $592.00", tone: "bad" },
    ],
