...
const CARDS: CardData[] = [
  {
    ...
    levels: [
      { label: "Area of Interest", value: "Holding above VWAP ($142.50)" },
      { label: "Range", value: "$145 – $150", tone: "flow" },
      { label: "Key Level", value: "$147 (prior day high)" },
      { label: "Support", value: "$138 (prior day low)", tone: "bad" },
    ],
  ...
  },
  {
    ...
    levels: [
      { label: "Area of Interest", value: "Reclaim VWAP ($176.00)" },
      { label: "Range", value: "$182 – $188", tone: "flow" },
      { label: "Key Level", value: "$180 (prior day high)" },
      { label: "Support", value: "$168 (prior day low)", tone: "bad" },
    ],
  ...
  },
  {
    ...
    levels: [
      { label: "Area of Interest", value: "Trading below VWAP ($584.00)" },
      { label: "Range", value: "$575 – $568", tone: "flow" },
      { label: "Key Level", value: "$578" },
      { label: "Resistance", value: "$592 (prior day high)", tone: "bad" },
    ],
